...
| **kimm-deck** | KIMM 보고 덱을 두 양식으로 생성 — **design.kimm**(4:3 기록용: 네이비 구조색+상태색, 아키타입 8종)과 **design.editorial**(16:9 설득용: 슬라이드당 메시지 1개, 이중 막대·실축척 스케일). 양식별 python-pptx 헬퍼 + 검증된 예제 동봉 | "kimm 덱 양식으로 과제 보고 ppt 만들어줘" / "설득력 있는 진행상황 덱" |
...
| kimm-deck | `python-pptx` (+선택: LibreOffice·poppler — 이미지 QA용) |
