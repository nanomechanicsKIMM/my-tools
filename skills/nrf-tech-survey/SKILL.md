---
name: nrf-tech-survey
description: NRF(한국연구재단) 미래개척융합과학기술개발사업 기술수요조사서를 HWPX로 자동 생성하는 스킬. '기술수요조사서', 'NRF 수요조사', '미래개척 수요조사서', '수요조사 hwpx' 등의 요청 시 사용. 2단계·3단계 양식을 지원하며 심사자 에이전트의 8기준 80점 게이트(최대 3회 반복)로 품질을 보증한다. hwpx·hwpx-xml 스킬 엔진 필요.
---
