---
name: teach
description: Teach the user a new skill or concept over multiple sessions in a dedicated workspace — mission-grounded lessons, learning records, spaced retrieval (storage strength), zone of proximal development. 국문 트리거 "가르쳐줘", "teach me", "논문 정독/학습", "Deep Thinking Hour", "개념 학습".
disable-model-invocation: true
argument-hint: "What would you like to learn about?"
---

<!-- Source: davidondrej/skills · thinking-and-docs/teach (MIT License, © 2026 David Ondrej). Vendored for LLM_wiki. Aux: MISSION/LEARNING-RECORD/GLOSSARY/RESOURCES-FORMAT.md. Full license: ../_shared/THIRD-PARTY.md -->
